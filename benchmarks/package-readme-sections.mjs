...
if (!delegated) {
  ...
  },
  {
    ...
    "role": "Hierarchical swarm plans, lanes, compute profiles, ownership policy, task queues, event streams, run records, changed-path checks, and proof artifacts for Frontier agent work.",
  ...
  },
  {
    ...
    "role": "Node Codex CLI adapter for Frontier swarm plans, including prompt rendering, worktree and snapshot workspaces, Codex argument construction, JSONL capture, verification commands, and result artifacts.",
