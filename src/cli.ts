...
function printHelp() {
  console.log([
    ...
    '  run       Run planned jobs, then coordinator-drain by default',
    ...
    '  autonomous-apply',
    '            Drain ready bundles under a repo lock using queue decisions',
    ...
    '  --no-auto-drain (raw worker diagnostics only; disables coordinator drain)',
