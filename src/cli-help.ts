export function printHelp(): void {
  console.log([
    ...
    '  import-run Import an older run directory into frontier-run run-events.jsonl',
    '  run-events import Import an older run directory into frontier-run run-events.jsonl',
    ...
    '  --run-events <file|false> --run-dashboard <file|false>',
