...
export function enrichCollectedCoordinatorDashboard(
  ...
  mutable.summary = {
    ...
    collectionIgnoredWorkspaceNoiseOwnershipViolationSignalCount: collectionQualitySignals.ownership.ignoredWorkspaceNoiseViolationCount,
    collectionQuarantinedChangedPathSignalCount: collectionQualitySignals.quarantine.sourcePathCount,
    collectionIgnoredWorkspaceNoiseQuarantinedChangedPathSignalCount: collectionQualitySignals.quarantine.ignoredWorkspaceNoisePathCount,
