...
import { FRONTIER_SWARM_CODEX_ARTIFACT_STORE_KIND, FRONTIER_SWARM_CODEX_ARTIFACT_STORE_VERSION, FRONTIER_SWARM_CODEX_SEMANTIC_IMPORT_KIND } from './constants.js';
...
import { FRONTIER_CODEX_PLAYWRIGHT_PROOF_PARENT_RECHECK_FILE } from './proof-parent-recheck-tasks.js';
...
function artifactKindForEvidencePath(file: string): string {
  ...
  if (name === FRONTIER_CODEX_PLAYWRIGHT_PROOF_READMISSION_FILE) return 'playwright-proof-readmission';
