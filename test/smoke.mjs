...
import { testProofRouteCollectionAutomation, testProofRouteTasks } from './smoke/proof-route-tasks.mjs';
import { testPlaywrightRuntimeProofArtifactCollection } from './smoke/proof-artifacts.mjs';
...
import { testContinuationMergeMetricsFeedback } from './smoke/continuation-merge-metrics.mjs';
...
import { testDistributedRun } from './smoke/distributed-run.mjs';
...
await testDistributedRun(context);
...
await testContinuationMergeMetricsFeedback(context, collectionDir);
...
testProofRouteTasks(mergeBundle);
await testProofRouteCollectionAutomation(context, mergeBundle);
await testPlaywrightRuntimeProofArtifactCollection(context, mergeBundle);
